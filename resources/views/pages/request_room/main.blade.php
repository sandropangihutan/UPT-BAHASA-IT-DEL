                            ...
                            <div class="dt-buttons d-inline-flex mt-50">
                                ...
                                @if($role == 2 || $role == 3)
                                    <a class="dt-button add-new btn btn-primary"
                                        href="{{ route('request-rooms.create') }}">
                                    ...
                                    @if(Auth::user()->id == $item->user_id && $item->status == 'pending')
                                        <div class="d-inline-flex">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end" style="">
                                                <a href="{{ route('request-rooms.edit', $item->id) }}"
                                                ...
                                                <form
                                                    action="{{ route('request-rooms.destroy', $item->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('delete')
                                            ...
                                            <a href="{{ route('request-rooms.edit', $item->id) }}" class="dropdown-item delete-record">
