                ...
                <table class="user-list-table table dataTable no-footer dtr-column" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                    <thead class="table-light">
                        <tr role="row">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 183.475px;" aria-label="Billing: activate to sort column ascending">Image</th>
                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 183.475px;" aria-label="Billing: activate to sort column ascending">Description</th>
                    ...
                    <tbody>
                        ...
                        <tr class="odd">
                            ...
                            <td valign="top" class="dataTables_empty"><img src="{{ asset('images/'.$item->image) }}" alt=""  width="200px" height="150px"></td>
                            ...
                            <td>
                                @can('Admin')
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" style="">
                                        <a href="{{ route('inventories.edit', $item->id) }}" class="dropdown-item delete-record">
